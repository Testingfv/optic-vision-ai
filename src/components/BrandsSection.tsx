...
export const BrandsSection = () => {
  ...
  return (
    <section ref={sectionRef} id="marcas" className="py-20 bg-secondary/20">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            {brands.map((brand, index) => (
              <div
                key={brand.name}
                className={`animate-on-scroll absolute ${brand.position} transform -translate-x-1/2 -translate-y-1/2`}
              >
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
            {['Ray-Ban', 'Oakley', 'Persol', 'Tom Ford'].map((brand, index) => (
              <div
                key={brand}
                className="animate-on-scroll text-center p-6 bg-background rounded-xl hover-lift border border-border/50"
              >
